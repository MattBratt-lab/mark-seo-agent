-- Seed blog posts (idempotent). Run after 0001_blog_posts.sql.
DELETE FROM blog_posts WHERE slug IN ('garage-door-repair-cost-palm-beach', 'why-garage-door-spring-keeps-breaking', 'garage-door-opener-troubleshooting', 'garage-door-maintenance-checklist-florida', 'diy-vs-professional-garage-door-repair', 'garage-door-replace-vs-repair-signs', 'garage-door-spring-lifespan-florida');

INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('garage-door-repair-cost-palm-beach', 'Guides', 'How Much Does Garage Door Repair Cost in Palm Beach County?', 'Typical repair ranges in Palm Beach County, what drives price (springs, openers, cables), and when replacement is the smarter investment.', '<section class="blog-body space-y-6">
...
</section>', '2026-05-01T14:00:00Z');
INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('why-garage-door-spring-keeps-breaking', 'Guides', 'Why Your Garage Door Spring Keeps Breaking (and How to Stop the Cycle)', 'Cycle life, garage humidity, mismatched springs, and skipped tune-ups — what actually causes repeat spring failures in Florida.', '<section class="blog-body space-y-6">
...
</section>', '2026-05-03T14:00:00Z');
INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('garage-door-opener-troubleshooting', 'Guides', 'Garage Door Opener Troubleshooting: Problems You Can Diagnose Before Calling', 'Remote checks, safety sensors, manual disconnect, and breaker tests — a sane order of operations before requesting service.', '<section class="blog-body space-y-6">
...
</section>', '2026-05-05T14:00:00Z');
INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('garage-door-maintenance-checklist-florida', 'Guides', 'Garage Door Maintenance Checklist for Florida Homeowners', 'Humidity, storms, and UV create a Florida-specific maintenance plan — inspection points you can track seasonally.', '<section class="blog-body space-y-6">
...
</section>', '2026-05-06T14:00:00Z');
INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('diy-vs-professional-garage-door-repair', 'Guides', 'DIY vs Professional Garage Door Repair: What Is Safe to Attempt?', 'Which tasks are homeowner-friendly versus high-risk (springs, cables, winding bars) under Florida safety norms.', '<section class="blog-body space-y-6">
...
</section>', '2026-05-07T14:00:00Z');
INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('garage-door-replace-vs-repair-signs', 'Guides', 'Signs You Need a New Garage Door vs When Repair Is Enough', 'Panel damage, insulation goals, recurring breakdowns, and safety upgrades — clear decision signals for replacement.', '<section class="blog-body space-y-6">
...
</section>', '2026-05-08T14:00:00Z');
INSERT INTO blog_posts (slug, city, title, excerpt, content, created_at) VALUES ('garage-door-spring-lifespan-florida', 'Guides', 'How Long Do Garage Door Springs Last in Florida?', 'Cycle ratings, coastal corrosion, and maintenance habits — realistic lifespan expectations for Palm Beach County.', '<section class="blog-body space-y-6">
